<?php
// utbn-backend/api/partner_analytics_viewers.php
session_start();
...
if($video_id<=0){ http_response_code(400); echo json_encode(["ok"=>false,"error"=>"MISSING_VIDEO_ID"],JSON_UNESCAPED_UNICODE); exit; }
...
echo json_encode(["ok"=>true,"video"=>$own,"items"=>$items],JSON_UNESCAPED_UNICODE);
